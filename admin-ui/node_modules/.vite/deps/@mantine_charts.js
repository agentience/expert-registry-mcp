import {
  ...
  YAxis,
  ZAxis
} from "./chunk-IPF6TQ5W.js";
import "./chunk-L5VVFUPP.js";
import {
  Box,
  ColorSwatch,
  Group,
  ...
  useStyles
} from "./chunk-22RAOASQ.js";
import "./chunk-KCXZGCB2.js";
import {
  useId
...
// node_modules/@mantine/charts/esm/Heatmap/Heatmap.module.css.mjs
var classes10 = { "root": "m_2ef228c3", "rect": "m_2ef201c5", "monthLabel": "m_7e977775", "weekdayLabel": "m_c4b68f8d" };
...
var Heatmap = factory((_props, ref) => {
  const props = useProps("Heatmap", defaultProps15, _props);
  const {
    classNames,
    className,
    style,
  ...
  const [hoveredRect, setHoveredRect] = (0, import_react9.useState)(null);
  ...
  const rotatedWeekdayLabels = (0, import_react9.useMemo)(
    ...
    const days = week.map((date, dayIndex) => {
      ...
      return (0, import_jsx_runtime18.jsx)(
        "rect",
        {
          ...
          ...getRectProps == null ? void 0 : getRectProps({ date, value: rectValue }),
          ...getStyles("rect")
        },
        date
      );
    });
    return (0, import_jsx_runtime18.jsx)("g", { transform: `translate(${weekIndex * rectSizeWithGap}, 0)`, "data-id": "week", children: days }, weekIndex);
  });
  ...
  const weekdayLabelsNodes = withWeekdayLabels && weekdayLabels ? rotatedWeekdayLabels.map((weekdayLabel, dayIndex) => (0, import_jsx_runtime18.jsx)(
    "text",
    {
      x: 0,
      ...
      children: [
        (0, import_jsx_runtime18.jsx)(
          Tooltip.Floating,
          {
            ...
            position: "top",
            ...tooltipProps,
            children: (0, import_jsx_runtime18.jsxs)("g", { transform: `translate(${weekdaysOffset}, ${monthsOffset})`, "data-id": "all-weeks", children: [
              withTooltip && (0, import_jsx_runtime18.jsx)(
                "rect",
                {
                  fill: "transparent",
